package com.a_ches.mvp.activity
...
import com.a_ches.mvp.common.UserAdapter
...
class SingleActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        /*
        findViewById(R.id.add).setOnClickListener(object : OnClickListener() {
            fun onClick(v: View?) {
                addUser()
            }
        })

        findViewById(R.id.clear).setOnClickListener(object : OnClickListener() {
            fun onClick(v: View?) {
                clearUsers()
            }
        })
